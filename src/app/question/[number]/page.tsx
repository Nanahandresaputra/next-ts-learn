...
export default function Question() {
  ...
  const [btnAnsw, setBtnAnsw] = useState<boolean>(false);
  ...
  return (
    ...
    >
      <LoadingPage isLoadingQuestion={btnAnsw}>
      <section className="flex justify-center">
        ...
        <div className="flex relative justify-center w-11/12 lg:w-10/12 mt-[14vh] h-[85vh] md:h-[80vh] rounded-lg bg-green-900 ">
          ...
          <div className="w-10/12 mt-[10vh] md:mt-[15vh] space-y-16 md:space-y-28 overflow-auto">
