...
import { correctAnswer, inCorrectAnswer, resetQuestion } from '@/store/siderSlice';
            ...
            <section className="flex justify-center">
                <div className="flex flex-col space-y-7 md:space-y-5 items-center w-10/12 md:w-11/12 lg:w-10/12 mt-[14vh] h-[80vh] rounded-lg bg-green-900 bg-opacity-50">
                    ...
                    <div className='grid grid-cols-2 gap-7'>
                        ...
                        <p className='col-span-2 bg-orange-600 border-2 border-black py-[1vh] md:py-[2vh] text-white font-semibold text-2xl md:text-4xl rounded-lg shadow-lg text-center'>
                            Score {correct}
                        </p>
                        ...
                        <Button type='primary' size='large' className='col-span-2 bg-green-900 text-lg  md:text-2xl justify-center py-6 font-semibold md:py-8 flex items-center' onClick={handleNewQuiz}>New Quiz</Button>
                    </div>
                </div>
            </section>
       </ConfigProvider> 
